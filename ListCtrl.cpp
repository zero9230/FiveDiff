...
IMPLEMENT_DYNAMIC(CListCtrlCl, CBCGPListCtrl)
...
BEGIN_MESSAGE_MAP(CListCtrlCl, CBCGPListCtrl)
	ON_WM_MEASUREITEM()
...
void CListCtrlCl::PreSubclassWindow()
{
	...
	CBCGPHeaderCtrl *pHeader =& GetHeaderCtrl();
...
void CListCtrlCl::OnMeasureItem(int nIDCtl, LPMEASUREITEMSTRUCT lpMeasureItemStruct)
{
	...
	CBCGPListCtrl::OnMeasureItem(nIDCtl, lpMeasureItemStruct);
}
