...
IMPLEMENT_DYNAMIC(CMyBCGPHeaderCtrl, CBCGPHeaderCtrl)

CMyBCGPHeaderCtrl::CMyBCGPHeaderCtrl() : m_R(171), m_G(199), m_B(235), m_Gradient(8)
{
	m_Format = "";
	m_fontHeight = 15;
	m_fontWith = 0;
...
CMyBCGPHeaderCtrl::~CMyBCGPHeaderCtrl()
{
}


BEGIN_MESSAGE_MAP(CMyBCGPHeaderCtrl, CBCGPHeaderCtrl)
	ON_WM_PAINT()
...
void CMyBCGPHeaderCtrl::OnPaint()
{
...
LRESULT CMyBCGPHeaderCtrl::OnLayout(WPARAM wParam, LPARAM lParam)
{
	LRESULT lResult = CBCGPHeaderCtrl::DefWindowProc(HDM_LAYOUT, 0, lParam);
